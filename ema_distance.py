...
def calculate_enhanced_ema_analysis(df, touch_threshold=1, lookback_period=30, max_distance_below_ema=2):
    """
...
async def run_scan_and_report(binance_client, reporter, proxy_pool):
    ...
    MAX_DISTANCE_BELOW_EMA = float(os.getenv("MAX_DISTANCE_BELOW_EMA", "2"))
